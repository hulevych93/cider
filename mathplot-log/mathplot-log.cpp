...
void MathplotLogger::plot() const {
    ...
    plt::plot(ieps_, rwrd_, std::map<std::string, std::string>{{"label", "Total Reward"},
                                                               {"color", "red"},
                                                               {"linestyle", "-"},
                                                               {"linewidth", "1.0"}});
    plt::grid(true);
    ...
    plt::plot(jeps_, loss_, std::map<std::string, std::string>{{"label", "Average Loss"},
                                                                 {"color", "blue"},
                                                                 {"linestyle", "-"},
                                                                 {"linewidth", "1.0"}});
    plt::grid(true);
    ...
    plt::plot(keps_, lr_, std::map<std::string, std::string>{{"label", "Learning Rate"},
                                                                   {"color", "green"},
                                                                   {"linestyle", "-"},
                                                                   {"linewidth", "1.0"}});
    plt::xlabel("Epochs");
