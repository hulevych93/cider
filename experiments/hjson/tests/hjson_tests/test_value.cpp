...
static const std::string name = "test_value";
...
void run_tests(const std::function<void(const char* name,
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value valVec(Hjson::HjsonHooked::Type::Vector);
    assert(valVec.type() == Hjson::HjsonHooked::Type::Vector);
    Hjson::HjsonHooked::Value valMap(Hjson::HjsonHooked::Type::Map);
    assert(valMap.type() == Hjson::HjsonHooked::Type::Map);
  });

  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val(true);
    assert(val.type() == Hjson::HjsonHooked::Type::Bool);
    assert(val);
    assert(val == true);
    assert(val != false);
    ...
    assert(!!val);
    { assert(Hjson::HjsonHooked::Marshal(val) == "true"); }
    val = false;
    assert(!val);
    assert(!val.empty());
    // size() is the number of child elements, can only be > 0 for Vector or
    // Map.
    assert(val.size() == 0);
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val(Hjson::HjsonHooked::Type::Null);
    assert(val.type() == Hjson::HjsonHooked::Type::Null);
    assert(!val);
    assert(val.empty());
    assert(val.size() == 0);
    Hjson::HjsonHooked::Value val2(Hjson::HjsonHooked::Type::Null);
    assert(val == val2);
    Hjson::HjsonHooked::Value val3;
    assert(val != val3);
    assert(val.to_double() == 0);
    assert(val.to_int64() == 0);
    assert(val.to_string() == "null");
    { assert(Hjson::HjsonHooked::Marshal(val) == "null"); }
  ...
  tests.emplace_back([]() {
    const Hjson::HjsonHooked::Value val = 3.0;
    assert(val == 3.0);
    assert(val != 4.0);
    assert(3.0 == val);
    assert(4.0 != val);
    ...
    { assert(Hjson::HjsonHooked::Marshal(val) == "3.0"); }
    assert(val.type() != Hjson::HjsonHooked::Type::Int64);
    // The result of the comparison is undefined in C++11.
    // assert(val.begin() == val.end());
  });

  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val = 3.0;
    Hjson::HjsonHooked::Value val2 = 3.0;
    assert(val == val2);
    assert(val != val2 + 1);
    assert(val2 + 1 != val);
  ...
  tests.emplace_back([]() {
    ...
    { assert(Hjson::HjsonHooked::Marshal(val) == "1"); }
    assert(val.type() == Hjson::HjsonHooked::Type::Int64);
    int i = 2;
    Hjson::HjsonHooked::Value val2(i);
    assert(val2 != val);
    assert(val2 > val);
    assert(val < val2);
    assert(val2 > 1);
    ...
    assert((val2 - 1) == static_cast<double>(i - 1));
    char i3 = 4;
    Hjson::HjsonHooked::Value val3(i3);
    assert(val3 == 4);
    assert(4 == val3);
    assert(val3 == i3);
    assert(i3 == val3);
    ...
    i3 = val3;
    assert(i3 == 4);
    Hjson::HjsonHooked::Value val4("-1");
    assert(val4.to_double() == -1);
    assert(val4.to_int64() == -1);
    assert(val4.to_string() == "-1");
    { assert(Hjson::HjsonHooked::Marshal(val4) == "\"-1\""); }
    Hjson::HjsonHooked::Value val5(-1);
    assert(val5 == -1);
    assert(val5 < val);
    assert(val5 < 1.0);
    short i6 = -28;
    Hjson::HjsonHooked::Value val6(i6);
    assert(val6 == -28);
    assert(-28 == val6);
    assert(val6 == i6);
    assert(i6 == val6);
    ...
    Hjson::HjsonHooked::Value val7(i7);
    assert(val7 == 29);
    assert(29 == val7);
    assert(val7 == i7);
    assert(i7 == val7);
    ...
    assert(val7 == 0);
    unsigned char i8 = 4;
    Hjson::HjsonHooked::Value val8(i8);
    assert(val8 == 4);
    assert(4 == val8);
    assert(val8 == i8);
    assert(i8 == val8);
    ...
    assert(!(val8 < i8));
    unsigned int i9 = 4;
    Hjson::HjsonHooked::Value val9(i9);
    assert(val9 == 4);
    assert(4 == val9);
    assert(val9 == i9);
    assert(i9 == val9);
  ...
  tests.emplace_back([]() {
    ...
    char i2 = 100;
    Hjson::HjsonHooked::Value val1(i1);
    Hjson::HjsonHooked::Value val2 = i2;
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val(144115188075855873);
    assert(val.type() == Hjson::HjsonHooked::Type::Int64);
    assert(val == Hjson::HjsonHooked::Value(144115188075855873));
    assert(val != Hjson::HjsonHooked::Value(144115188075855874));
    assert(val.to_int64() == 144115188075855873);
    assert(static_cast<std::int64_t>(val) == 144115188075855873);
    val = Hjson::HjsonHooked::Value(9223372036854775807);
    assert(val.to_string() == "9223372036854775807");
    assert(val == Hjson::HjsonHooked::Value(9223372036854775807));
    assert(val != Hjson::HjsonHooked::Value(9223372036854775806));
    assert(val.to_int64() == 9223372036854775807);
    assert(val > Hjson::HjsonHooked::Value(9223372036854775806));
    std::int64_t i = 9223372036854775806;
    std::int64_t i2 = 9223372036854775806;
    Hjson::HjsonHooked::Value val2(i);
    assert(val2 == Hjson::HjsonHooked::Value(i));
    assert(val2 != val);
    assert(val2 < val);
    assert(val > val2);
    assert(val2 < Hjson::HjsonHooked::Value(9223372036854775807));
    ...
    // assert((val2 + 1) == static_cast<double>(i + 1));
    // assert((val2 - 1) == static_cast<double>(i - 1));
    Hjson::HjsonHooked::Value val6 = 9223372036854775807;
    assert(val6 == 9223372036854775807);
    Hjson::HjsonHooked::Value val7("-9223372036854775806");
    assert(val7.to_int64() == -9223372036854775806);
    assert(val7.to_string() == "-9223372036854775806");
    Hjson::HjsonHooked::Value val8(-9223372036854775806);
    assert(val8 == Hjson::HjsonHooked::Value(-9223372036854775806));
    assert(val8.to_int64() == -9223372036854775806);
    assert(val8 < val);
    assert(val8 < 1.0);
    std::int64_t i3 = 144115188075855873;
    Hjson::HjsonHooked::Value val9 = i3;
    assert(val9 == i3);
    assert(i3 == val9);
    assert(!(val9 > i3));
    assert(!(val9 < i3));
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val1(
        "92233720368547758073829419051489548484843823585675828488686");
    Hjson::HjsonHooked::Value val2(
        "92233720368547758073829419051489548484843823585675828488686.0");
    Hjson::HjsonHooked::Value val3(
        92233720368547758073829419051489548484843823585675828488686.0);
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val1 = 3;
    val1 += 1;
    assert(val1 == 4);
    assert(++val1 == 5);
    assert(val1 == 5);
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val("alpha");
    Hjson::HjsonHooked::Value val2 = "alpha";
    assert(val == val2);
    assert(val != "beta");
    assert("beta" != val);
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val("alpha");
    Hjson::HjsonHooked::Value val2 = "beta";
    assert(val < val2);
    assert(val2 > val);
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val;
    val["first"] = "leaf1";
    Hjson::HjsonHooked::Value val2 = val["first"];
    val["second"] = val["first"];
    val["fourth"] = 4.0;
    const Hjson::HjsonHooked::Value& valC = val;
  ...
  tests.emplace_back([]() {
    ...
    Hjson::HjsonHooked::Value undefined = val["down1"]["down2"]["down3"];
    assert(undefined.type() == Hjson::HjsonHooked::Type::Undefined);
    assert(!val.defined());
  });
  ...
  tests.emplace_back([]() {
    ...
    root["one"] = 1;
    {
      Hjson::HjsonHooked::Value test1 = root["one"];
      root.erase(0);
    }
    assert(root.empty());
  });
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val1, val2;
  ...
  tests.emplace_back([]() {
    ...
    Hjson::HjsonHooked::Value val2 = root["key1"]["key2"]["key3"];
    val2["B"] = 5;
  ...
  tests.emplace_back([]() {
    ...
    val.push_back(2);
    std::string f = val[0];
    Hjson::HjsonHooked::Value val2 = val[0];
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val;
    Hjson::HjsonHooked::Value val2 = val["åäö"];
    assert(!val2.defined());
    assert(val["åäö"].type() == Hjson::HjsonHooked::Type::Undefined);
    // Assert that the comparison didn't create an element.
    assert(val.size() == 0);
    Hjson::HjsonHooked::Value sub1, sub2;
    val["abc"] = sub1;
    val["åäö"] = sub2;
    assert(val["åäö"].type() == Hjson::HjsonHooked::Type::Undefined);
    ...
    assert(val.size() == 2);
    std::string generatedHjson = Hjson::HjsonHooked::Marshal(val);
    assert(generatedHjson == "{\n}");
    Hjson::HjsonHooked::EncoderOptions options;
    options.preserveInsertionOrder = false;
    generatedHjson = Hjson::HjsonHooked::Marshal(val, options);
    assert(generatedHjson == "{\n}");
    sub1["sub1"] = "abc";
    sub2["sub2"] = "åäö";
    generatedHjson = Hjson::HjsonHooked::Marshal(val);
    assert(generatedHjson ==
           "{\n  abc: {\n    sub1: abc\n  }\n  åäö: {\n    sub2: åäö\n  }\n}");

    Hjson::HjsonHooked::Value val3 = Hjson::HjsonHooked::Unmarshal(
        generatedHjson.c_str(), generatedHjson.size());
  ...
  tests.emplace_back([]() {
    ...
    Hjson::HjsonHooked::Value val2("secondVal");
    try {
      val2.erase("key1");
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value root =
        Hjson::HjsonHooked::Unmarshal("[3,4,5]", 8);
    assert(root[0] == 3);
    assert(root[1] == 4);
    assert(root[2] == 5);
    assert(root.size() == 3);
  ...
  tests.emplace_back([]() {
    ...
    val2 = 1;
    assert(val1.deep_equal(val2));
    val1 = Hjson::HjsonHooked::Value();
    val1.push_back(2);
    assert(!val1.deep_equal(val2));
    val2 = Hjson::HjsonHooked::Value();
    val2["2"] = 2;
    assert(!val1.deep_equal(val2));
    val1 = Hjson::HjsonHooked::Value(Hjson::HjsonHooked::Type::Vector);
    val2 = Hjson::HjsonHooked::Value(Hjson::HjsonHooked::Type::Vector);
    assert(val1.deep_equal(val2));
    val1 = Hjson::HjsonHooked::Value(Hjson::HjsonHooked::Type::Map);
    assert(!val1.deep_equal(val2));
    val2 = Hjson::HjsonHooked::Value(Hjson::HjsonHooked::Type::Map);
    assert(val1.deep_equal(val2));
  });
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val1;
    val1["first"] = 1;
    Hjson::HjsonHooked::Value val2 = val1.clone();
    val1["second"] = 2;
    assert(val2.size() == 1);
    val1["third"]["first"] = 3;
    val2 = val1.clone();
  ...
  tests.emplace_back([]() {
    ...
    assert(val1[2] == 99);
    val1.move(1, 0);
    auto str = Hjson::HjsonHooked::Marshal(val1);
    assert(str == "{\n  xerxes: {\n    first: 3\n  }\n  y: 2\n  zeta: 99\n}");
  ...
  window: {
    ...
    Hjson::HjsonHooked::Value base = Hjson::HjsonHooked::Unmarshal(baseStr);

    Hjson::HjsonHooked::Value ext = Hjson::HjsonHooked::Unmarshal(R"(
{
  debug: true
  rect: {
    x: 0
  ...
  otherWindow: {
    ...
    Hjson::HjsonHooked::Value merged = Hjson::HjsonHooked::Merge(base, ext);
    ...
    auto baseCloneStr = Hjson::HjsonHooked::Marshal(baseClone);
    assert(baseCloneStr == baseStr);
    Hjson::HjsonHooked::EncoderOptions options;
    options.bracesSameLine = true;
    options.preserveInsertionOrder = true;
    baseCloneStr = Hjson::HjsonHooked::Marshal(baseClone, options);
    assert(baseCloneStr == baseStr);
  });
...
// base 18
    ...
    Hjson::HjsonHooked::DecoderOptions decOpt;
    decOpt.whitespaceAsComments = true;
    Hjson::HjsonHooked::Value base =
        Hjson::HjsonHooked::Unmarshal(baseStr, decOpt);
    Hjson::HjsonHooked::Value ext =
        Hjson::HjsonHooked::Unmarshal(extStr, decOpt);
    Hjson::HjsonHooked::Value merged = Hjson::HjsonHooked::Merge(base, ext);
    assert(merged["debug"] == true);
    assert(merged["rect"]["width"] == 800);
    assert(merged["rect"]["height"] == 480);
    ...
    auto baseClone = base.clone();
    Hjson::HjsonHooked::EncoderOptions encOpt;
    encOpt.bracesSameLine = true;
    encOpt.preserveInsertionOrder = true;
    encOpt.omitRootBraces = true;
    auto baseCloneStr = Hjson::HjsonHooked::Marshal(baseClone, encOpt);
    assert(baseCloneStr == baseStr);
    auto extClone = ext.clone();
    auto extCloneStr = Hjson::HjsonHooked::Marshal(extClone, encOpt);
    assert(extCloneStr == extStr);
    auto mergedStrResult = Hjson::HjsonHooked::Marshal(merged, encOpt);
...
arr: [
  ...
  2
    ...
    auto root = Hjson::HjsonHooked::Unmarshal(noRootBraces);
    auto newStr = Hjson::HjsonHooked::Marshal(root, options);
...
beta: a// cm 2)";
    ...
    Hjson::HjsonHooked::DecoderOptions decOpt;
    decOpt.whitespaceAsComments = true;
    auto root = Hjson::HjsonHooked::Unmarshal(noLineFeedAtEnd, decOpt);

    auto newStr = Hjson::HjsonHooked::Marshal(root);
...
beta: a// cm 2
    ...
    root = Hjson::HjsonHooked::Unmarshal(lineFeedAtEnd, decOpt);
    newStr = Hjson::HjsonHooked::Marshal(root);
    assert(newStr == expectedStr);
  });
  ...
  tests.emplace_back([]() {
    ...
    auto root1 =
        Hjson::HjsonHooked::UnmarshalFromFile("assets/charset_test.hjson");
    assert(!root1.empty());
    try {
  ...
  tests.emplace_back([]() {
    ...
    auto root1 = Hjson::HjsonHooked::UnmarshalFromFile(
        "assets/comments6_test.hjson", decOpt);
    assert(!root1.empty());

    Hjson::HjsonHooked::MarshalToFile(root1, szTmp, encOpt);
    auto root2 = Hjson::HjsonHooked::UnmarshalFromFile(szTmp, decOpt);
    assert(root2.deep_equal(root1));
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value val1(1), val2(2);
    ...
    auto fnValOne = [](const Hjson::HjsonHooked::Value& val) { return val; };

    Hjson::HjsonHooked::Value val4 = fnValOne(val1);
    ...
    auto fnValTwo = [](Hjson::HjsonHooked::Value val) { return val; };

    Hjson::HjsonHooked::Value val5 = fnValTwo(val1);
    ...
    Hjson::HjsonHooked::Value val6 = val1;
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value root(Hjson::HjsonHooked::Type::Map);
    ...
    Hjson::HjsonHooked::EncoderOptions opt;
    opt.separator = true;
    auto str = Hjson::HjsonHooked::Marshal(root, opt);
    assert(str == R"({
  // comment inside
  one: 1, # afterOne
  two: 2,
  ...
  tests.emplace_back([]() {
    Hjson::HjsonHooked::Value root(Hjson::HjsonHooked::Type::Vector);
    root.set_comment_inside("\n  // comment inside\n");
    root.push_back(1);
  ...
  tests.emplace_back([]() {
    ...
    Hjson::HjsonHooked::DecoderOptions decOpt;
    decOpt.whitespaceAsComments = true;
    auto root = Hjson::HjsonHooked::Unmarshal(txt, decOpt);

    Hjson::HjsonHooked::EncoderOptions encOpt;
    encOpt.separator = true;
    auto newStr = Hjson::HjsonHooked::Marshal(root, encOpt);

    auto expectedStr =
        R"([ 0, 1, "c", 3, /*4, 5,*/ 6, "h", /*'i', */"j", "k" ])";
    assert(newStr == expectedStr);

    encOpt.separator = false;
    newStr = Hjson::HjsonHooked::Marshal(root, encOpt);
   ...
   k 
    ...
    root = Hjson::HjsonHooked::Unmarshal(txt, decOpt);
    newStr = Hjson::HjsonHooked::Marshal(root, encOpt);
  ...
  tests.emplace_back([]() {
    auto txt =
        R"({ k1: 0, k2:1, k3: 'c', k4: 3, /*k5:4, k6 : 5,*/ k7 : 6, k8:'h', /*k9:'i', */k10:'j', k11 : 'k' })";
  ...
  tests.emplace_back([]() {
    ...
    auto str = Hjson::HjsonHooked::Marshal(val);
...
2
    ...
    Hjson::HjsonHooked::DecoderOptions decOpt;
    decOpt.whitespaceAsComments = true;
    auto root = Hjson::HjsonHooked::Unmarshal(str, decOpt);
    auto str2 = Hjson::HjsonHooked::Marshal(root);
    assert(str2 == str);
  });
...
alfa: a
  beta: b
    ...
    Hjson::HjsonHooked::DecoderOptions decOpt;
    decOpt.comments = true;
    auto root = Hjson::HjsonHooked::Unmarshal(str1, decOpt);
    std::ostringstream oss;
    Hjson::HjsonHooked::EncoderOptions encOpt;
    encOpt.quoteAlways = true;
    encOpt.omitRootBraces = true;
    oss << Hjson::HjsonHooked::Marshal(root, encOpt);
    auto str2 = oss.str();
    assert(str2 == str1);
    str2 = Hjson::HjsonHooked::Marshal(root);
    assert(str2 == strPlain);
    Hjson::HjsonHooked::Value root2;
    std::stringstream ss(str1);
    root2 = Hjson::HjsonHooked::Unmarshal(ss.str(), decOpt);
    assert(root2.deep_equal(root));
    ss.str(str1);
    root2 = Hjson::HjsonHooked::Unmarshal(ss.str(), decOpt);
    assert(root2.deep_equal(root));
    str2 = Hjson::HjsonHooked::Marshal(root2, encOpt);
    assert(str2 == str1);
    auto se = Hjson::HjsonHooked::Marshal(root, encOpt);
    oss.str("");
    oss << se;
    str2 = oss.str();
    assert(str2 == str1);
...
key: val2
    ...
    auto root = Hjson::HjsonHooked::Unmarshal(str);
    try {
      Hjson::HjsonHooked::DecoderOptions decOpt;
