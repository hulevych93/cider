...
TEST_XML(
  ...
  CHECK_DOUBLE(double(node.child(STR("text6")).text().as_float()),
...
TEST_XML(dom_text_assign, "<node/>") {
  ...
  CHECK_NODE(node, STR("<node><text1>v1</text1><text2>-2147483647</"
                       ...
                       "text6><text7>0.25</text7><text8>true</text8></node>"));
}
...
TEST_XML(dom_text_assign_long, "<node/>") {
  ...
  CHECK_NODE(
      node,
      STR("<node><text1>-2147483647</text1><text2>-2147483648</"
          "text2><text3>4294967295</text3><text4>4294967294</text4></node>"));
}
