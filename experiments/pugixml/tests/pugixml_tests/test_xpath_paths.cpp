...
TEST_XML(xpath_paths_axes_child,
         ...
         "attr='value'><subchild/></child><another/><last/></node>") {
  xml_node c;
  ...
  CHECK_XPATH_NODESET(n, STR("child:: node()")) % 4 % 7 %
      8;  // child, another, last
...
TEST_XML(xpath_paths_axes_descendant,
         "<node attr='value'><child "
         "attr='value'><subchild/></child><another><subchild/></another><last/"
         "></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  xpath_node na(n.attribute(STR("attr")), n);
  ...
  CHECK_XPATH_NODESET(n, STR("descendant:: node()")) % 4 % 6 % 7 % 8 %
      9;  // child, subchild, another, subchild, last
  CHECK_XPATH_NODESET(doc, STR("descendant:: node()")) % 2 % 4 % 6 % 7 % 8 %
      9;  // node, child, subchild, another, subchild, last
...
TEST_XML(xpath_paths_axes_parent,
         "<node attr='value'><child "
         "attr='value'><subchild/></child><another><subchild/></another><last/"
         "></node>") {
  xml_node c;
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")), STR("parent:: node()")) %
      2;                                                              // node
...
TEST_XML(xpath_paths_axes_ancestor,
         "<node attr='value'><child "
         "attr='value'><subchild/></child><another><subchild/></another><last/"
         "></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  xpath_node na(n.child(STR("child")).attribute(STR("attr")),
                n.child(STR("child")));

  CHECK_XPATH_NODESET(c, STR("ancestor:: node()"));

  CHECK_XPATH_NODESET(n.child(STR("child")), STR("ancestor:: node()")) % 2 %
      1;  // node, root
  CHECK_XPATH_NODESET(n, STR("child/subchild/ancestor:: node()")) % 4 % 2 %
      1;  // child, node, root
  CHECK_XPATH_NODESET(n, STR("child/@attr/ancestor:: node()")) % 4 % 2 %
      1;                                                 // child, node, root
  CHECK_XPATH_NODESET(n, STR("ancestor:: node()")) % 1;  // root
  CHECK_XPATH_NODESET(doc, STR("ancestor:: node()"));

  CHECK_XPATH_NODESET(na, STR("ancestor:: node()")) % 4 % 2 %
      1;  // child, node, root
}

TEST_XML(xpath_paths_axes_following_sibling,
         "<node attr1='value' attr2='value'><child "
         "attr='value'><subchild/></child><another><subchild/></another><last/"
         "></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")),
                      STR("following-sibling:: node()")) %
      8 % 10;  // another, last
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("following-sibling:: node()"));

  CHECK_XPATH_NODESET(
      n,
      STR("@attr1/following-sibling:: node()"));  // attributes are not siblings
  CHECK_XPATH_NODESET(
      na, STR("following-sibling:: node()"));  // attributes are not siblings
}
...
TEST_XML(xpath_paths_axes_preceding_sibling,
  ...
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("preceding-sibling:: node()")) %
      8 % 5;  // another, child

  CHECK_XPATH_NODESET(
      n,
      STR("@attr2/following-sibling:: node()"));  // attributes are not siblings
  CHECK_XPATH_NODESET(
      na, STR("following-sibling:: node()"));  // attributes are not siblings
}
...
TEST_XML(xpath_paths_axes_following,
         "<node attr1='value' attr2='value'><child "
         "attr='value'><subchild/></child><another><subchild/></"
         "another><almost/><last/></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  xpath_node na(n.attribute(STR("attr1")), n);
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")), STR("following:: node()")) % 8 %
      9 % 10 % 11;  // another, subchild, almost, last
  CHECK_XPATH_NODESET(n.child(STR("child")).child(STR("subchild")),
                      STR("following:: node()")) %
      8 % 9 % 10 % 11;  // another, subchild, almost, last
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("following:: node()"));

  CHECK_XPATH_NODESET(n, STR("@attr1/following::node()")) % 5 % 7 % 8 % 9 % 10 %
      11;  // child, subchild, another, subchild, almost, last - because
           // @/following
  CHECK_XPATH_NODESET(n, STR("child/@attr/following::node()")) % 7 % 8 % 9 %
      10 % 11;  // subchild, another, subchild, almost, last
  CHECK_XPATH_NODESET(na, STR("following::node()")) % 5 % 7 % 8 % 9 % 10 %
      11;  // child, subchild, another, subchild, almost, last - because
           // @/following
}

TEST_XML(xpath_paths_axes_preceding,
         "<node attr1='value' attr2='value'><child "
         "attr='value'><subchild/></child><another><subchild "
         "id='1'/></another><almost/><last/></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  xpath_node na(n.child(STR("child")).attribute(STR("attr")),
                n.child(STR("child")));
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")),
                      STR("preceding:: node()"));  // no ancestors
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("preceding:: node()")) % 11 %
      9 % 8 % 7 % 5;  // almost, subchild, another, subchild, child
  CHECK_XPATH_NODESET(n.child(STR("another")).child(STR("subchild")),
                      STR("preceding:: node()")) %
      7 % 5;  // subchild, child
  CHECK_XPATH_NODESET(n, STR("preceding:: node()"));

  CHECK_XPATH_NODESET(n, STR("child/@attr/preceding::node()"));  // no ancestors
  CHECK_XPATH_NODESET(n, STR("//subchild[@id]/@id/preceding::node()")) % 7 %
      5;                                              // subchild, child
  CHECK_XPATH_NODESET(na, STR("preceding::node()"));  // no ancestors
}

TEST_XML(xpath_paths_axes_attribute,
         "<node attr1='value' attr2='value'><child "
         "attr='value'><subchild/></child><another "
         "xmlns:foo='bar'><subchild/></another><last/></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  xpath_node na(n.attribute(STR("attr1")), n);
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")), STR("attribute:: node()")) %
      6;  // child/@attr
  CHECK_XPATH_NODESET(n.child(STR("last")), STR("attribute:: node()"));
  CHECK_XPATH_NODESET(n, STR("attribute:: node()")) % 3 %
      4;  // node/@attr1 node/@attr2
  CHECK_XPATH_NODESET(doc,
                      STR("descendant-or-self:: node()/attribute:: node()")) %
      3 % 4 % 6;  // all attributes
  CHECK_XPATH_NODESET(
      n.child(STR("another")),
      STR("attribute:: node()"));  // namespace nodes are not attributes
...
TEST_XML(xpath_paths_axes_self,
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")), STR("self:: node()")) %
      4;                                                         // child
...
TEST_XML(xpath_paths_axes_descendant_or_self,
  ...
  CHECK_XPATH_NODESET(n, STR("descendant-or-self:: node()")) % 2 % 4 % 6 % 7 %
      8 % 9;  // node, child, subchild, another, subchild, last
  CHECK_XPATH_NODESET(doc, STR("descendant-or-self:: node()")) % 1 % 2 % 4 % 6 %
      7 % 8 % 9;  // root, node, child, subchild, another, subchild, last
  CHECK_XPATH_NODESET(n, STR("another/descendant-or-self:: node()")) % 7 %
      8;  // another, subchild
...
TEST_XML(xpath_paths_axes_ancestor_or_self,
         "<node attr='value'><child "
         "attr='value'><subchild/></child><another><subchild/></another><last/"
         "></node>") {
  xml_node c;
  ...
  CHECK_XPATH_NODESET(n.child(STR("child")), STR("ancestor-or-self:: node()")) %
      4 % 2 % 1;  // child, node, root
  CHECK_XPATH_NODESET(n, STR("child/subchild/ancestor-or-self:: node()")) % 6 %
      4 % 2 % 1;  // subchild, child, node, root
  CHECK_XPATH_NODESET(n, STR("child/@attr/ancestor-or-self:: node()")) % 5 % 4 %
      2 % 1;  // @attr, child, node, root
  CHECK_XPATH_NODESET(n, STR("ancestor-or-self:: node()")) % 2 %
      1;                                                           // root, node
  CHECK_XPATH_NODESET(doc, STR("ancestor-or-self:: node()")) % 1;  // root
  CHECK_XPATH_NODESET(n, STR("ancestor-or-self:: node()")) % 2 %
      1;  // root, node
  CHECK_XPATH_NODESET(n, STR("last/ancestor-or-self::node()")) % 9 % 2 %
      1;  // root, node, last
  CHECK_XPATH_NODESET(na, STR("ancestor-or-self:: node()")) % 5 % 4 % 2 %
      1;  // @attr, child, node, root
}
...
TEST_XML(xpath_paths_nodetest_all,
         "<node a1='v1' x:a2='v2'><c1/><x:c2/><c3/><x:c4/></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
...
TEST_XML_FLAGS(xpath_paths_nodetest_name,
               "<node a1='v1' x:a2='v2'><c1/><x:c2/><c3/><x:c4/><?c1?></node>",
...
TEST_XML_FLAGS(xpath_paths_nodetest_type,
...
TEST_XML_FLAGS(
    xpath_paths_nodetest_principal,
    "<node attr='value'>pcdata<child/><?pi1 value?><?pi2 "
    "value?><!--comment--><![CDATA[cdata]]></node><abra:cadabra abra:arba=''/>",
    parse_default | parse_pi | parse_comments) {
  ...
  CHECK_XPATH_NODESET(doc,
                      STR("//attribute::node()/ancestor-or-self::node()")) %
      1 % 2 % 3 % 10 % 11;
  ...
  CHECK_XPATH_NODESET(
      doc, STR("node/attribute::attr/self::attr"));  // attribute is not of
                                                     // element type
  CHECK_XPATH_NODESET(doc, STR("node/child::child/ancestor-or-self::child")) %
      5;
  CHECK_XPATH_NODESET(
      doc,
      STR("node/attribute::attr/ancestor-or-self::attr"));  // attribute is not
                                                            // of element type
  CHECK_XPATH_NODESET(doc, STR("node/child::child/descendant-or-self::child")) %
      5;
  CHECK_XPATH_NODESET(
      doc,
      STR("node/attribute::attr/descendant-or-self::attr"));  // attribute is
                                                              // not of element
                                                              // type

  // any name test is true only for node with principal node type (depends on
  // axis)
  ...
  CHECK_XPATH_NODESET(
      doc,
      STR("node/attribute::*/self::*"));  // attribute is not of element type
  CHECK_XPATH_NODESET(doc, STR("node/child::*/ancestor-or-self::*")) % 5 % 2;
  CHECK_XPATH_NODESET(doc, STR("node/attribute::*/ancestor-or-self::*")) %
      2;  // attribute is not of element type
  CHECK_XPATH_NODESET(doc, STR("node/child::*/descendant-or-self::*")) % 5;
  CHECK_XPATH_NODESET(
      doc, STR("node/attribute::*/descendant-or-self::*"));  // attribute is not
                                                             // of element type

  // namespace test is true only for node with principal node type (depends on
  // axis)
  ...
  CHECK_XPATH_NODESET(
      doc,
      STR("child::abra:*/attribute::abra:*/self::abra:*"));  // attribute is not
                                                             // of element type
  CHECK_XPATH_NODESET(doc, STR("child::abra:*/ancestor-or-self::abra:*")) % 10;
  CHECK_XPATH_NODESET(
      doc, STR("child::abra:*/attribute::abra:*/ancestor-or-self::abra:*")) %
      10;  // attribute is not of element type
  CHECK_XPATH_NODESET(doc, STR("child::abra:*/descendant-or-self::abra:*")) %
      10;
  CHECK_XPATH_NODESET(doc,
                      STR("child::abra:*/attribute::abra:*/"
                          "descendant-or-self::abra:*"));  // attribute is not
                                                           // of element type
}

TEST_XML(xpath_paths_nodetest_attribute_namespace,
         "<node a1='v1' xmlns:x='?' />") {
...
TEST_XML(xpath_paths_absolute,
         "<node attr='value'><foo><foo/><foo/></foo></node>") {
  xml_node c;
  xml_node n = doc.child(STR("node"));
  xpath_node na(n.attribute(STR("attr")), n);
...
TEST_XML(xpath_paths_predicate_boolean,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
  xml_node n = doc.child(STR("node"))
                   .child(STR("chapter"))
                   .next_sibling()
                   .next_sibling();
...
TEST_XML(xpath_paths_predicate_number,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
  xml_node n = doc.child(STR("node"))
                   .child(STR("chapter"))
                   .next_sibling()
...
TEST_XML(xpath_paths_predicate_number_boundary,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
...
TEST_XML(xpath_paths_predicate_number_out_of_range,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
  xml_node n = doc.child(STR("node"))
                   .child(STR("chapter"))
                   .next_sibling()
...
TEST_XML(xpath_paths_predicate_constant_boolean,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
  xml_node n = doc.child(STR("node"))
                   .child(STR("chapter"))
                   .next_sibling()
  ...
  CHECK_XPATH_NODESET_VAR(n, STR("following-sibling::chapter[$true]"), &set) %
      6 % 7;
}

TEST_XML(xpath_paths_predicate_position_eq,
         "<node><chapter/><chapter/><chapter>3</chapter><chapter/><chapter/></"
         "node>") {
...
TEST_XML(xpath_paths_predicate_several,
...
TEST_XML(xpath_paths_predicate_filter_boolean,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
  xml_node n = doc.child(STR("node"))
                   .child(STR("chapter"))
                   .next_sibling()
...
TEST_XML(xpath_paths_predicate_filter_number,
         "<node><chapter/><chapter/><chapter/><chapter/><chapter/></node>") {
  xml_node n = doc.child(STR("node"))
                   .child(STR("chapter"))
                   .next_sibling()
...
TEST_XML(xpath_paths_predicate_filter_posinv,
         "<node><employee/><employee secretary=''/><employee "
         "assistant=''/><employee secretary='' assistant=''/><employee "
         "assistant='' secretary=''/></node>") {
  xml_node n = doc.child(STR("node"));
...
TEST_XML(xpath_paths_step_compose,
         "<node><foo><foo/><foo/></foo><foo/></node>") {
  xml_node n = doc.child(STR("node"));
...
TEST_XML(
    xpath_paths_descendant_double_slash_w3c,
    "<node><para><para/><para/><para><para/></para></para><para/></node>") {
...
TEST_XML(xpath_paths_needs_sorting,
         "<node><child/><child/><child><subchild/><subchild/></child></node>") {
  CHECK_XPATH_NODESET(doc, STR("(node/child/subchild)[2]")) % 7;
}

TEST_XML(
    xpath_paths_descendant_filters,
    "<node><para><para/><para/><para><para/></para></para><para/></node>") {
  CHECK_XPATH_NODESET(doc, STR("//para[1]")) % 3 % 4 % 7;
  CHECK_XPATH_NODESET(doc, STR("/descendant::para[1]")) % 3;
  ...
  CHECK_XPATH_NODESET(doc, STR("/descendant::para[true()]")) % 3 % 4 % 5 % 6 %
      7 % 8;
...
TEST_XML(
    xpath_paths_descendant_optimize,
    "<node><para><para/><para/><para><para/></para></para><para/></node>") {
  CHECK_XPATH_NODESET(doc, STR("//para")) % 3 % 4 % 5 % 6 % 7 % 8;
  CHECK_XPATH_NODESET(doc, STR("/descendant-or-self::node()/child::para")) % 3 %
      4 % 5 % 6 % 7 % 8;
  CHECK_XPATH_NODESET(
      doc, STR("/descendant-or-self::node()[name()='para']/child::para")) %
      4 % 5 % 6 % 7;
  CHECK_XPATH_NODESET(
      doc, STR("/descendant-or-self::node()[name()='para']/child::para[1]")) %
      4 % 7;
  CHECK_XPATH_NODESET(doc, STR("/descendant-or-self::node()[3]/child::para")) %
      4 % 5 % 6;
}

TEST_XML(
    xpath_paths_descendant_optimize_axes,
    "<node><para><para/><para/><para><para/></para></para><para/></node>") {
  CHECK_XPATH_NODESET(doc, STR("//.")) % 1 % 2 % 3 % 4 % 5 % 6 % 7 % 8;
  CHECK_XPATH_NODESET(doc, STR("//descendant::*")) % 2 % 3 % 4 % 5 % 6 % 7 % 8;
  CHECK_XPATH_NODESET(doc, STR("//descendant-or-self::*")) % 2 % 3 % 4 % 5 % 6 %
      7 % 8;

  CHECK_XPATH_NODESET(doc, STR("//..")) % 1 % 2 % 3 % 6;
  CHECK_XPATH_NODESET(doc, STR("//ancestor::*")) % 2 % 3 % 6;
  CHECK_XPATH_NODESET(doc, STR("//ancestor-or-self::*")) % 2 % 3 % 4 % 5 % 6 %
      7 % 8;
...
TEST_XML(
    xpath_paths_descendant_optimize_last,
    "<node><para><para/><para/><para><para/></para></para><para/></node>") {
  CHECK_XPATH_NODESET(doc, STR("//para[last()]")) % 6 % 7 % 8;
  CHECK_XPATH_NODESET(doc, STR("//para[last() = 1]")) % 7;
}

TEST_XML(xpath_paths_precision,
         "<node><para/><para/><para/><para/><para/></node>") {
...
TEST_XML(xpath_paths_unsorted_child,
         "<node><foo><bar/></foo><node><foo><bar/></foo></node><foo><bar/></"
         "foo></node>") {
...
TEST_XML(xpath_paths_optimize_compare_attribute,
         "<node id='1' /><node id='2' /><node xmlns='3' />") {
...
TEST_XML(xpath_paths_optimize_step_once,
         "<node><para1><para2/><para3/><para4><para5 "
         "attr5=''/></para4></para1><para6/></node>") {
...
TEST_XML(xpath_paths_null_nodeset_entries, "<node attr='value'/>") {
  ...
  xpath_node_set rs =
      xpath_query(STR("$x/."), &vars).evaluate_node_set(xml_node());
...
TEST_XML(xpath_paths_step_leaf_coverage,
         "<n><n1/><n2 a='v'><child/></n2><n3/></n>") {
...
TEST_XML(xpath_paths_step_leaf_predicate_coverage,
         "<n><n1/><n2 a='v'><child/></n2><n3/></n>") {
  xml_node n = doc.child(STR("n")).child(STR("n2"));
...
TEST_XML(xpath_paths_step_step_coverage,
         "<n><n1/><n2 a='v'><child/></n2><n3/></n>") {
  xml_node n = doc.child(STR("n")).child(STR("n2"));
...
TEST_XML(xpath_paths_step_step_predicate_coverage,
         "<n><n1/><n2 a='v'><child/></n2><n3/></n>") {
  xml_node n = doc.child(STR("n")).child(STR("n2"));
